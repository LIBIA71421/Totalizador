...
form.addEventListener("submit", (event) => {
  ...
  impuestoDiv.innerHTML = "<p>Impuesto para "+estado.value+"(%"+ multiplicar(imp,100).toFixed(2) +"): $" +totalImpuesto+"</p>";
  TOTALDiv.innerHTML = "<p>Precio total (desceunto e impuesto): $"+ totalPrecio +"</p>";
});
